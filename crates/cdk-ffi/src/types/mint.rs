...
pub struct Nuts {
    ...
    /// NUT-XX Settings - Quote offers (draft)
    pub nutxx_supported: Option<bool>,
...
impl From<cdk::nuts::Nuts> for Nuts {
    fn from(nuts: cdk::nuts::Nuts) -> Self {
        ...
        Self {
            ...
            nutxx_supported: nuts.nutxx.map(|settings| settings.supported),
            mint_units,
            melt_units,
        }
    }
...
impl TryFrom<Nuts> for cdk::nuts::Nuts {
    ...
    fn try_from(n: Nuts) -> Result<Self, Self::Error> {
        Ok(Self {
            ...
            nutxx: n
                .nutxx_supported
                .map(|supported| cdk::nuts::nut06::SupportedSettings { supported }),
        })
    }
}
